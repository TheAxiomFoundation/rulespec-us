...
- This campaign added source-grounded pilots for **18** jurisdictions (DC, HI,
  IA, IN, KS, LA, MO, MT, ND, NJ, NM, OK, OR, PA, RI, SC, WA, WI), bringing
  liability comparison coverage to **39 of 44** jurisdictions when Colorado is
  included.
- No liability comparison remains for **5** jurisdictions (AR, MS, NH, VT, WV).
...
| Source-ready follow-on | KS, MO, ND, NJ, PA, SC | 6 pilots; proof/test green; oracle residuals typed below |
| Source/vintage blockers | AR, MS, NH, VT, WV | typed below |
...
The 18 new pipelines pass 108/108 engine companion cases. Fourteen reproduce
...
across the east, central, and west batches; the KS/MO/ND/NJ/PA/SC follow-on
...
of the 29 citations used by the 18 pilots. Source verification still lacks
these 26 active citation paths:
...
1. Land the 18 source-grounded liability candidates and companion tests.
