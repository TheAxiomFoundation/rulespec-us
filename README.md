...
- `.axiom/toolchain.toml`: legacy repository-validation pins plus immutable
  corpus-release and validation-waiver evidence identities used by generation.
- `.axiom/workflow-toolchain.toml`: immutable dependency checkout SHAs used by
  generation and source-staleness workflows.
